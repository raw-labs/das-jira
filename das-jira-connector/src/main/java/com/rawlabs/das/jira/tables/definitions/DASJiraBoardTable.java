...
public class DASJiraBoardTable extends DASJiraBaseTable {
  ...
  private final DASJiraTableDefinition<GetAllBoards200ResponseValuesInner> dasJiraTableDefinition =
      this.buildTable();
  ...
  public DASJiraTableDefinition<GetAllBoards200ResponseValuesInner> buildTable() {
  ...
  public HydrateFunction<GetAllBoards200ResponseValuesInner> hydrateFunction =
          ...
          if (id != null) {
            ...
            GetAllBoards200Response getAllBoards200Response =
                boardApi.getAllBoards(
                    ...
                    null,
                    null);
            List<GetAllBoards200ResponseValuesInner> values = getAllBoards200Response.getValues();
