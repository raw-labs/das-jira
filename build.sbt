...
lazy val publishSettings = Seq(
  ...
  publishTo := Some("GitHub raw-labs Apache Maven Packages" at "https://maven.pkg.github.com/raw-labs/das-jira"),
...
lazy val root = (project in file("."))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.rawlabs.das.rest" % "jira-rest-client" % "1001.0.0-SNAPSHOT-bccdae9a1b3c45b4ace2d33db0008d855c13cad7",
...
lazy val dockerSettings = strictBuildSettings ++ Seq(
  ...
  dockerAliases := {
    val devRegistry = sys.env.getOrElse("DEV_REGISTRY", "ghcr.io/raw-labs/das-jira")
